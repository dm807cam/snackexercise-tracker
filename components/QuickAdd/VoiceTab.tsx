  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <textarea
        ...
        className="w-full resize-none rounded-lg px-3 py-2.5 text-base"
        style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}
      />
      ...
      <div className="flex flex-wrap gap-1.5">
        {EXAMPLES.map((example) => (
          <button
            ...
            className="rounded-full px-2.5 py-1 text-xs text-dim"
            style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}
          >
            {example}
          </button>
    ...
    <div className="surface rounded-xl px-3 py-2.5">
      <div className="flex items-start gap-2">
        <div className="min-w-0 flex-1">
          ...
          {proposal.notes && <p className="mt-0.5 text-xs text-dim">{proposal.notes}</p>}
        </div>
        <button
          type="button"
          onClick={onRemove}
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full rounded-lg px-2 py-1.5 text-sm tabular-nums"
        style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}
      />
    </label>
  );
